...
class MaterialTableWidget(QWidget):
    def __init__(self, theme="light", headers=None, parent=None):
        ...
        if self.theme == "dark":
            self.table.setStyleSheet("background-color: #121212; border: 0px solid #ffffff; color: white; border-radius:8px;")
        else:
            self.table.setStyleSheet("background-color: #FFFFFF; border: 0px solid #ffffff; color: black; border-radius:8px;")
